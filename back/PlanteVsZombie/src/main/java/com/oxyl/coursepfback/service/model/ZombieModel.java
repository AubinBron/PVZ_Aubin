...
public class ZombieModel {
    ...
    public ZombieModel(int id, String nom, int point_de_vie, float attaque_par_seconde, int degat_attaque, float vitesse_de_deplacement, String chemin_image, int id_map) {
        this.id_zombie = id;
        this.nom = nom;

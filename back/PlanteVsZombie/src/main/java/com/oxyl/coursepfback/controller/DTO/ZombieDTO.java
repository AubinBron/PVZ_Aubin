...
import com.oxyl.coursepfback.controller.validation.ZombieAnnotation;
...
public class ZombieDTO {
    ...
    @NotBlank(message = "Le nom du zombie ne peut pas être vide")
    private String nom;

    @Positive(message = "Les point de vie ne peuvent pas être nuls ou négatifs")
    private int point_de_vie;

    @Positive(message = "L'attaque par seconde ne peut pas être nulle ou négative")
    private float attaque_par_seconde;

    @Positive(message = "Le dégât d'attaque ne peut pas être nul ou négatif")
    private int degat_attaque;

    @Positive(message = "La vitesse de déplacement ne peut pas être nulle ou négative")
    private float vitesse_de_deplacement;

    @NotBlank(message = "Le chemin de l'image ne peut pas être vide")
    private String chemin_image;

    @ZombieAnnotation.MapIdExists
    private int id_map;


    public ZombieDTO() {
    }
    public ZombieDTO(int id, String nom, int point_de_vie, float attaque_par_seconde, int degat_attaque, float vitesse_de_deplacement, String chemin_image, int id_map) {
        this.id_zombie = id;
        this.nom = nom;

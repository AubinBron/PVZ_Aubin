...
public class PlanteModel {
    ...
    public PlanteModel(int id_plante, String nom, int point_de_vie, float attaque_par_seconde, int degat_attaque, int cout, float soleil_par_seconde, String effet, String chemin_image){
